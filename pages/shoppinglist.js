...
const shoppinglist = () => {
  return (
    ...
    <div className='w-screen h-[30vh] lg:h-[30vh] relative'>
      <div className='absolute top-0 left-0 w-full h-[35vh] lg:h-[35vh] bg-[#0077B6]/90 md:bg-[#0077B6]/80  z-10' />
        ...
        <div className='col-span-4 md:col-span-1 shadow-xl rounded-xl bg-white hover:bg-gradient-to-r from-[#023E8A] to-[#0077B6] group  hover:text-white '>
          <div className='py-9'>
            ...
            <div className='grid grid-cols-3 sm:grid-cols-1 md:grid-cols-1'>
              <p className=' text-[#023E8A] flex items-center group-hover:text-white '><FaDotCircle size={10} className='mx-4' />Vanilla JavaScript</p>
              <p className=' text-[#023E8A] flex items-center group-hover:text-white '><FaDotCircle size={10} className='mx-4' />Local Storage</p>
            </div>
          </div>
        </div>
      </div>
