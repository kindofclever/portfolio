      ...
      <div className="max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 pt-8 ml-5">
        <div className="col-span-4">
          ...
          <p>
            ...
            rights to share the code. But I made a short clip where you can see
            the part of the code that I wrote in action.For this code challenge
            I had to animate an elevator system with 20 floors and 5 elevator
            cabins. The goal was to fetch the cabins and their current position
            from the backend and visualize them in the frontend. Also I had to
            make sure that when I press a floor button, that the best fitting
            elevator cabin appears. I could decide for myself which cabin was
            the "best", so I decided to write an algorithem that checks for the
            closest elevator: Like this the people who press the button don't
