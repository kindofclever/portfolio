...
const About = () => {
  ...
  return (
    <motion.div exit={{opacity: 0}} id='about' className='sm:mr-5  md:mr-5 md:h-screen p-2 flex items-center py-16'>
        <div className='max-w-[1240px] m-auto md:grid grid-cols-3 gap-8 ml-5 '>
            <div className='col-span-2'>
                <motion.p
                  className='text-[#0077B6] uppercase text-xl tracking-widest'>
                    About me
                </motion.p>
