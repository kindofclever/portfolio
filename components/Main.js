...
const Main = () => {
  return (
    <div className='w-full h-screen text-center xs:mt-10'>
        <div className='max-w-[1240px] w-full bottom-0 flex justify-center items-centers lg:mt-[10%]'>
            <div>
                ...
                <p className='pt-4 pb-0 max-w-[70%] m-auto'>
                    ...
                    attend the <span>School of Applied Thechnology JavaScript Bootcamp</span>. I got familiar with <span className=''>TDD, agile working methods,</span>
                ...
                <div className='flex items-center justify-evenly max-w-[350px] m-auto pt-5 sm:max-w[300px] md:pt-5'>
                    <div className='bg-[#0077B6] text-[#ff9e00] p-2 m-1 rounded-full shadow-xl cursor-pointer hover:scale-[125%] ease-in duration-200'>
