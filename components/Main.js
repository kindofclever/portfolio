...
const Main = () => {
    ...
    const phoneComponent =  <div id='home' className='w-full h-screen text-center'>
  ...
  const computerComponent =  <div id='home' className='w-full h-screen text-center'>
                                <div className='max-w-[1240px] ml-3 w-full bottom-0 flex justify-center items-centers mt-[30%] lg:mt-[20%]'>
                                    <div> 
                                        <div> 
                                        <motion.p 
    ...
    return (
        <div>
        {isPhone ? phoneComponent : computerComponent}
        </div>
