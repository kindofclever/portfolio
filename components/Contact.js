                    ...
                    <div className='p-4'>
                        <form>
                            ...
                            <div className='flex flex-col'>
                                ...
                                <textarea required className='border-2 rounded-xl p-3 w-full flex border-[#0096C7]' rows='5'/>
                            </div>
                            <button className='w-full p-4 text-white mt-2 lg:mt-5'>Send message</button>
                        </form>
                    </div>
                </div>
            </div>
